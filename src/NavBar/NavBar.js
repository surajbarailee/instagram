                ...
                <div className="navContent">
                    ...
                    <div className="navButtonWrapper">
                        <div className="buttonContainer">
                            ...
                            <div style={{width: '22px', height: '22px'}} className = "svgWrapper">
                                <img  src={Profile} alt="instagram's profile" style={{width:'100%',height:'100%',borderRadius:'50px',cursor:'pointer'}}/>
                            </div> 
                        </div>
                    </div>
                </div>
...
{/* <div className="contentWrapper">
                    ...
                    <div className = 'navButtonWrapperContainer'>
                        <div className='navButtonWrapper'>
                            ...
                            <div className = 'navButton'>
                                ...
                                <div style={{width: '22px', height: '22px'}}>
                                    <img  src={Profile} alt="instagram's profile" style={{width:'100%',height:'100%',borderRadius:'50px'}}/>
                                </div> 
                                </div>
                            </div>
