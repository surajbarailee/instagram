                ...
                <div className='navContentWrapper'>
                    ...
                    {activeIcon==='profile'&&
                                    <div className='profileOption'>
                                        <div className="diamondDiv" style={{marginRight:'25px',zIndex:1}}/>
                                        <div className='profileContainerWrapper' style={{zIndex:-1}}>

                                            <div className='optionContainer' style={{zIndex:2}}>
                                                ...
                                                <div className="options" style={{borderBottom:'2px solid rgba(219,219,219,1)'}}>
                                                    <div className="svg">
